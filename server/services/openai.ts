...
`;
    ...
    const response = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: "You are an expert B2B sales intelligence analyst. Provide detailed, actionable insights for sales outreach purposes."
        },
        {
          role: "user",
          content: prompt
...
`;
    ...
    const response = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: "You are an expert B2B lead qualification analyst. Provide accurate scoring based on sales best practices."
        },
        {
          role: "user",
          content: prompt
...
`;
    ...
    const response = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: "You are an expert cold email copywriter with expertise in B2B sales outreach. Create compelling, personalized emails that generate responses."
        },
        {
          role: "user",
          content: prompt
...
`;
    ...
    const response = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: "You are a B2B research analyst specializing in prospect intelligence for sales outreach."
        },
        {
          role: "user",
          content: prompt
