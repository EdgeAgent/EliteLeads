        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-xl font-bold text-foreground">eliteleads.pro</h1>
            </div>
            <Button 
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-primary text-primary-foreground">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Join thousands of sales teams already using eliteleads.pro to generate more qualified leads and close more deals.
          </p>
          <Button 
            size="lg" 
            variant="secondary"
      ...
      <footer className="border-t border-border py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <div className="flex items-center justify-center space-x-3 mb-4">
            ...
            <span className="text-lg font-semibold">eliteleads.pro</span>
          </div>
          <p className="text-muted-foreground">
            © 2024 eliteleads.pro. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
